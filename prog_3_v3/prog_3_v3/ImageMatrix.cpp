...
// ‘ункци€ поиска среднего значени€ элементов массива (область размером w * h, начина€ с координат x, y)
...
// ‘ункци€ поиска cреднеквадратическое отклонение элементов массива (область размером w * h, начина€ с координат x, y)
